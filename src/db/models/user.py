...
class User(Base):
    ...
    cook_events: Mapped[list["UserCookEvent"]] = relationship(back_populates="user_rel")
    recipe_views: Mapped[list["UserRecipeView"]] = relationship(back_populates="user_rel")
